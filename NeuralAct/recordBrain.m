...
%RECORDBRAIN    Capture NeuralAct's graphical output into an avi file.
%
%   Iteratively calls NeuralAct with an activation data column of
...
%
%   For more information, see NeuralAct.
%
...
for col = range,
    ...
    NeuralAct( M, vcontribs, subjs, 1, cmapstruct, viewstruct );
